...
#define PARAMETER_TYPE_STRING_LEN	7 /* Non zero terminated string, the lenght of the string precedes the string */
#define PARAMETER_TYPE_MEMORY_BUFFER	8 /* A pointer to a memory buffer, the lenght of the string precedes the string */
